...
class PindustryModelVideos extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('id, company_id, type, published, ordering, `default`, GetTitle(name, "'.$com_pindustry_languages['defaultlang'].'", "pt-PT") AS name');
		$query->from('#__aniews_videos');
