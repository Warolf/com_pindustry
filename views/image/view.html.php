...
class PindustryViewImage extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		$title=$isNew ? JText::_('COM_ANIEWS_MANAGER_IMAGE_NEW') : JText::_('COM_ANIEWS_MANAGER_IMAGE_EDIT');
		...
		JToolBarHelper::cancel('image.cancel', $isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
	}
